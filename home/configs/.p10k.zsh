# Generated by Powerlevel10k configuration wizard on 2025-02-03 at 23:46 CET.
...
() {
  ...
  typeset -g POWERLEVEL9K_OS_ICON_BACKGROUND=0 # 1
  #Custom icon.
  ...
  typeset -g POWERLEVEL9K_DIR_BACKGROUND=0 #6
  ...
  typeset -g POWERLEVEL9K_TIME_BACKGROUND=0 # 4
