...
let
  ...
  rift-config = ''
    ...
    run_on_start = [
      "rift-cli subscribe cli --event workspace_changed --command sh --args -c --args '${pkgs.sketchybar} --trigger rift_workspace_changed RIFT_WORKSPACE_NAME=\"$RIFT_WORKSPACE_NAME\" RIFT_WORKSPACE_ID=\"$RIFT_WORKSPACE_ID\"'",
      "rift-cli subscribe cli --event windows_changed --command sh --args -c --args '${pkgs.sketchybar} --trigger rift_windows_changed RIFT_WORKSPACE_NAME=\"$RIFT_WORKSPACE_NAME\" RIFT_WINDOW_COUNT=\"$RIFT_WINDOW_COUNT\"'"
    ]
